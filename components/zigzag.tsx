      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <motion.div className="max-w-3xl mx-auto text-center pb-20" initial={{ opacity: 0, y: -20 }}
            ...
            viewport={{ once: true }} >
            <div className="inline-flex text-lg font-semibold py-3 px-4 sm:px-6 m-2 text-green-800 bg-green-200 rounded-full mb-8">Unlock true passive income streams.</div>
