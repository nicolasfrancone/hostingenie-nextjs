                    ...
                    <div className="relative pt-32 pb-6 md:pt-40 md:pb-6">
                        ...
                        <div className="mx-auto text-left pb-12 md:pb-20">
                            ...
                            <ul className="list-disc pl-6 text-xl text-gray-400">
                                ...
                                <li><strong>Runtime local:</strong> This cookie stores the conversation history on your device.</li>
                            </ul>
                            ...
                            <p className="text-xl text-gray-400 pb-10">To exercise your rights, please contact us at support@hostingenie.com.</p>
