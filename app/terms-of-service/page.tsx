        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative pt-32 pb-6 md:pt-40 md:pb-6">
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
              <h1 className="h1 mb-4 mt-8 sm:mt-0">Terms of Service</h1>
            </div>
            ...
            <div className="mx-auto text-left pb-12 md:pb-20">
              ...
              <ul className="list-disc pl-6 pb-10 text-xl text-gray-400">
                ...
                <li><strong>Information You Provide to the Chatbot:</strong> You may choose to provide the Chatbot with additional personal information, such as your email address, phone number, file attachments, or other contact information. This information is only collected if you choose to provide it and is used solely for the purposes described below.</li>
              </ul>
              ...
              <ul className="list-disc pl-6 pb-10 text-xl text-gray-400">
                ...
                <li><strong>To enable hosts to contact guests:</strong> We allow hosts to see the conversations you have with the Chatbot for context and to contact you directly if necessary.</li>
                <li><strong>To provide feedback to hosts:</strong> We allow hosts to see the conversations you have with the Chatbot to gather feedback and improve their hosting experience.</li>
                <li><strong>To personalize the Chatbot experience:</strong> We use a cookie to determine your browser's locale and display the Chatbot in your preferred language. We also use a cookie to store the conversation history on your device for a seamless experience.</li>
              </ul>
              ...
              <ul className="list-disc pl-6 pb-10 text-xl text-gray-400">
                ...
                <li><strong>Data Sharing:</strong> Information collected by Hostingenie is not shared with third parties and is kept secure within the Voiceflow and Voiceglow platforms.
                </li>
              </ul>
